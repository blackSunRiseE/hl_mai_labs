...
explain select * from Author where first_name='Name';
explain select * from Author where title='Title';
...
explain select * from Author where email='name_surname@gmail.com';
